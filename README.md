...
Для того, чтобы собрать проект, необходимо клонировать репозиторий на компьютер, а затем поочередно ввести в командной строке команды "npm i" и "npm run dev".
